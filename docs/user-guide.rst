...
`Discourse discussion forum <https://discourse.girderformindlogger.org>`_,
`on GitHub <https://github.com/girderformindlogger/girderformindlogger>`_, or `through Kitware support <mailto:kitware@kitware.com>`_.
