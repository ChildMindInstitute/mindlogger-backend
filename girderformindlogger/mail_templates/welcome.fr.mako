...
## <button href="${url}/accept" class="btn button btn-success btn-lg">Accepter l'invitation</button>
## <button href="${url}/decline" class="btn button btn-danger btn-lg">Décliner l'invitation</button>
