...
// girderformindlogger.corsAuth could be an override. See login doc below.
var corsAuth = true;
 ...
 * @param cors If the girderformindlogger server is on a different origin, set this
 *        to "true" to save the auth cookie on the current domain. Alternatively,
 *        you may set the global option "girderformindlogger.corsAuth = true".
