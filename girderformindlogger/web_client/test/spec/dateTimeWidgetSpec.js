describe('Test DateTimeWidget', function () {
    ...
    describe('default construction', function () {
        beforeEach(function () {
            widget = new girderformindlogger.views.widgets.DateTimeWidget({
                parentView: null
            });
            widget.render();
        });
        ...
        it('create multiple widgets', function () {
            var widget2 = new girderformindlogger.views.widgets.DateTimeWidget({
                parentView: null
            });
            widget2.render();
...
describe('Test DateTimeRangeWidget', function () {
    ...
    describe('default construction', function () {
        beforeEach(function () {
            widget = new girderformindlogger.views.widgets.DateTimeRangeWidget({
                parentView: null
            });
            widget.render();
        });
        ...
        it('create multiple widgets', function () {
            var widget2 = new girderformindlogger.views.widgets.DateTimeRangeWidget({
                parentView: null
            });
            widget2.render();
