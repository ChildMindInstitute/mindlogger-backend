...
function _setMinimumChunkSize(minSize) {
    ...
    if (!minUploadSize) {
        minUploadSize = { UPLOAD_CHUNK_SIZE: girderformindlogger.rest.getUploadChunkSize() };
    ...
    girderformindlogger.rest.setUploadChunkSize(uploadChunkSize);
...
describe('Create a data hierarchy', function () {
    ...
    it('upload a file into the current folder', function () {
        girderTest.testUpload('girderformindlogger/web_client/test/testFile.txt');
    ...
    it('search using quick search box', function () {
        ...
        runs(function () {
            ...
            expect(Backbone.history.fragment).toBe(
                'user/' + girderformindlogger.auth.getCurrentUser().get('_id'));
        });
    });
    ...
    it('upload a file without an extension', function () {
        ...
        girderTest.testUpload('girderformindlogger/web_client/test/testFile2');
    });
    ...
    it('download checked items', function () {
        ...
        runs(function () {
            ...
            widget = girderformindlogger.events._events['g:navigateTo'][0].ctx.bodyView.hierarchyWidget;
            spyOn(girderformindlogger.views.widgets.HierarchyWidget.prototype, 'redirectViaForm').andCallFake(function (method, url, data) {
    ...
    it('test copy permissions', function () {
        ...
        runs(function () {
            expect($('a.g-move-picked').length).toBe(0);
            expect($('a.g-copy-picked').length).toBe(0);
            oldPicked = girderformindlogger.views.widgets.HierarchyWidget.getPickedResources();
        ...
        runs(function () {
             ...
             * item selected. */
            girderformindlogger.views.widgets.HierarchyWidget.resetPickedResources(oldPicked);
            $('a.g-folder-list-link:first').click();
        });
        girderTest.waitForLoad();
        waitsFor(function () {
...
describe('Test FileModel static upload functions', function () {
    ...
    it('test prep - create top level folder', function () {
        runs(function () {
            var _folder = new girderformindlogger.models.FolderModel({
                parentType: 'user',
                parentId: girderformindlogger.auth.getCurrentUser().get('_id'),
    ...
    it('test prep - create item', function () {
        runs(function () {
            var _item = new girderformindlogger.models.ItemModel({
    ...
    it('test FileModel.uploadToFolder()', function () {
        ...
        runs(function () {
            fileModel = new girderformindlogger.models.FileModel();
        ...
        runs(function () {
            ...
            item = girderformindlogger.rest.restRequest({
                url: '/item',
                method: 'GET',
                data: {
                    folderId: folder.get('_id'),
            ...
            file = girderformindlogger.rest.restRequest({
