...
describe('Test normal collection operation', function () {
    it('create several dummy api keys', function () {
        ...
        var createPromise = $.when(
            new girderformindlogger.models.ApiKeyModel({ name: 'test0' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'test1' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'test2' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'test3' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'test4' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'test5' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'test6' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'test7' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'test8' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'test9' }).save()
        );

        var collection;

        var fetchPromise = createPromise.then(function () {
            collection = new girderformindlogger.collections.ApiKeyCollection();
    ...
    it('ensure collection fetch fires backbone "reset" event with expected options', function () {
        var done = canary();
        var collection = new girderformindlogger.collections.ApiKeyCollection();
...
describe('Test collection filtering', function () {
    it('create several dummy api keys', function () {
        ...
        var createPromise = $.when(
            new girderformindlogger.models.ApiKeyModel({ name: 'filterTest0' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'filterTest1' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'filterTest2' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'filterTest3' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'filterTest4' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'filterTest5' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'filterTest6' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'filterTest7' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'filterTest8' }).save(),
            new girderformindlogger.models.ApiKeyModel({ name: 'filterTest9' }).save()
        );

        var filteredCollection;

        var fetchPromise = createPromise.then(function () {
            filteredCollection = new girderformindlogger.collections.ApiKeyCollection();
