...
describe('Test EventStream', function () {
    ...
    it('test EventStream creation', function () {
        runs(function () {
            ...
            girderformindlogger.utilities.eventStream.on('g:eventStream.start', onEventStreamStart);

            onEventStreamStop = jasmine.createSpy('onEventStreamStop');
            girderformindlogger.utilities.eventStream.on('g:eventStream.stop', onEventStreamStop);

            onEventStreamClose = jasmine.createSpy('onEventStreamClose');
            girderformindlogger.utilities.eventStream.on('g:eventStream.close', onEventStreamClose);

            onVisibilityStateChangeSpy = spyOn(girderformindlogger.utilities.eventStream, '_onVisibilityStateChange');
        }, 'spy on EventStream');
    ...
    it('test EventStream auto-stop', function () {
        runs(function () {
            onVisibilityStateChangeSpy.andCallFake(function () {
                girderformindlogger.utilities.eventStream._stop();
            });
    ...
    it('test EventStream auto-start', function () {
        runs(function () {
            onVisibilityStateChangeSpy.andCallFake(function () {
                girderformindlogger.utilities.eventStream._start();
            });
