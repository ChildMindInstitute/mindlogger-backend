describe('Test the hierarchy browser modal', function () {
    ...
    beforeEach(function () {
        ...
        spyOn(girderformindlogger.rest, 'restRequest').andCallFake(function () {
    ...
    afterEach(function () {
        testEl.remove();
        girderformindlogger.auth.logout();
    ...
    describe('root selection', function () {
        it('defaults', function () {
            ...
            var view;
            runs(function () {
                view = new girderformindlogger.views.widgets.RootSelectorWidget({
                    el: testEl,
                    parentView: null
                });
        ...
        it('rerender on login', function () {
            ...
            girderformindlogger.rest.restRequest.andCallFake(function (params) {
            ...
            runs(function () {
                view.render.reset();
                girderformindlogger.auth.login('johndoe', 'password');
            });
        ...
        it('custom optgroup', function () {
            ...
            runs(function () {
                returnVal = [];
                col = new girderformindlogger.collections.CollectionCollection();
    ...
    describe('browser modal', function () {
        ...
        beforeEach(function () {
            ...
            spyOn(girderformindlogger.views.widgets.HierarchyWidget.prototype, 'render');
            spyOn(girderformindlogger.views.widgets.HierarchyWidget.prototype, 'initialize').andCallFake(fakeInitialize);
        });
        afterEach(function () {
            if (view) {
                view.$el.modal('hide');
        ...
        it('defaults', function () {
            returnVal = [];
            view = new girderformindlogger.views.widgets.BrowserWidget({
                parentView: null,
                el: testEl
            }).render();
        ...
        it('render hierarchy', function () {
            ...
            expect(hwSettings.parentModel).toBe(girderformindlogger.auth.getCurrentUser());
        ...
        it('item selection', function () {
            ...
            view = new girderformindlogger.views.widgets.BrowserWidget({
                ...
                titleText: 'This is a title',
                selectItem: true,
                root: girderformindlogger.auth.getCurrentUser(),
                rootSelectorSettings: {
                    display: ['Home']
                }
            }).render();

            var itemModel = new girderformindlogger.models.ItemModel({
                _id: '1',
                name: 'my item'
            });
