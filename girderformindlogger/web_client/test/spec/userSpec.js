...
describe('Create an admin and non-admin user', function () {
    ...
    it('create user as admin using dialog', function () {
        ...
        runs(function () {
            expect(girderformindlogger.auth.getCurrentUser().get('login')).toBe('admin');
        });
    });
    ...
    it('test changing other user\'s password', function () {
        runs(function () {
            girderformindlogger.router.navigate('useraccount/' + registeredUsers[1].id + '/password',
                { trigger: true });
        });
...
describe('test account approval', function () {
    it('Turn on approval policy', function () {
        ...
        runs(function () {
            girderformindlogger.router.navigate('user/' + registeredUsers[1].id,
                { trigger: true });
        });
        waitsFor(function () {
