...
describe('Test upload widget non-standard options', function () {
    it('create the widget', function () {
        runs(function () {
            ...
            new girderformindlogger.views.widgets.UploadWidget({
                noParent: true,
                modal: false,
                title: null,
                el: 'body',
...
describe('Test hierarchy widget non-standard options', function () {
    it('register a user', function () {
        runs(function () {
            var _user = new girderformindlogger.models.UserModel({
                login: 'mylogin',
                password: 'mypassword',
    ...
    it('create subfolder', function () {
        runs(function () {
            var _subfolder = new girderformindlogger.models.FolderModel({
                parentType: 'folder',
    ...
    it('test custom hierarchy widget options', function () {
        runs(function () {
            ...
            widget = new girderformindlogger.views.widgets.HierarchyWidget({
                el: 'body',
                parentModel: folder,
        ...
        runs(function () {
            ...
            return new girderformindlogger.views.widgets.HierarchyWidget({
                el: 'body',
                parentModel: folder,
                checkboxes: false,
                parentView: null,
...
describe('Test access widget with non-standard options', function () {
    ...
    it('test non-modal rendering', function () {
        runs(function () {
            widget = new girderformindlogger.views.widgets.AccessWidget({
                el: 'body',
                modal: false,
                model: folder,
                modelType: 'folder',
    ...
    it('test hiding elements', function () {
        runs(function () {
            ...
            return new girderformindlogger.views.widgets.AccessWidget({
                el: 'body',
                modal: false,
                model: folder,
                modelType: 'folder',
    ...
    it('test custom access flags UI', function () {
        ...
        runs(function () {
            ...
            xhr = girderformindlogger.rest.restRequest({
        ...
        runs(function () {
            ...
            expect(access.users[0].level).toBe(girderformindlogger.constants.AccessType.ADMIN);
...
describe('Test search widget with non-standard options', function () {
    it('test fixed search mode', function () {
        runs(function () {
            ...
            new girderformindlogger.views.widgets.SearchFieldWidget({
                el: 'body',
                modes: 'prefix',
                types: ['folder'],
                parentView: null,
...
describe('Test metadata widget with non-standard options', function () {
    it('test editing custom field with custom callbacks', function () {
        var widget;
        var model = new girderformindlogger.models.FolderModel({
            customMeta: {}
        });
        ...
        runs(function () {
            widget = new girderformindlogger.views.widgets.MetadataWidget({
                el: 'body',
                parentView: null,
                item: model,
                accessLevel: girderformindlogger.constants.AccessType.WRITE,
