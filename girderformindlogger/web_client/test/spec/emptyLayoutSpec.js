...
describe('Test empty and default layouts', function () {
    ...
    girderformindlogger.router.route('collections/emptylayout', 'collectionsEmptyLayout', function (params) {
        girderformindlogger.events.trigger('g:navigateTo', girderformindlogger.views.body.CollectionsView, params || {}, { layout: girderformindlogger.constants.Layout.EMPTY });
    });

    girderformindlogger.router.route('collections/defaultlayout', 'collectionsDefaultLayout', function (params) {
        girderformindlogger.events.trigger('g:navigateTo', girderformindlogger.views.body.CollectionsView, params || {}, { layout: girderformindlogger.constants.Layout.DEFAULT });
    });
