...
module.exports = function (grunt) {
    ...
    // want to instrument files that could be symlinked into node_modules from outside the girderformindlogger
    ...
    const plugins = grunt.config.get('pkg.girderformindlogger.plugins') || [];
    ...
    plugins.forEach(function (plugin) {
        ...
        let pluginWebpackConfig = {
            ...
            plugins: [
                ...
                // This plugin allows this bundle to dynamically link against girderformindlogger's
                // core library bundle.
                new webpack.DllReferencePlugin({
                    context: '.',
                    manifest: path.join(grunt.config.get('builtPath'), 'girder_lib-manifest.json')
