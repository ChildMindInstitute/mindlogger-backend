...
from girderformindlogger.utility import config, system
from girderformindlogger.utility.jsonld_expander import getByLanguage
...
class System(Resource):
    ...
    def getLog(self, bytes, log):
        path = girderformindlogger.getLogPaths()[log]
    ...
    def getLogLevel(self):
        level = girderformindlogger.logger.getEffectiveLevel()
    ...
    def setLogLevel(self, level):
        ...
        for logger in (girderformindlogger.logger, cherrypy.log.access_log, cherrypy.log.error_log):
