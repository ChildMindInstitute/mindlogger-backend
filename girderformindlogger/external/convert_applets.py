...
applets = Applet().find(query={ 'meta.applet': { '$exists': True } })

print('total', applets.count())
for applet in applets:
    if applet['_id'] != ObjectId("62ce5a1bc956895bbaaeb1e2"):
        continue
    ...
    g = []
    for activityIRI in dict.keys(formatted['activities']):
    ...
    jsonld_expander.formatLdObject(applet, 'applet', None, refreshCache=True)
