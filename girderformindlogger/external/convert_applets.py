...
for index, appletId in enumerate(applets, start=1):
    ...
    activityFlowsExist = 'protocol' in protocol['meta'] and 'reprolib:terms/activityFlowOrder' in protocol['meta']['protocol'] and len(protocol['meta']['protocol']['reprolib:terms/activityFlowOrder'][0]['@list']) > 0



    if not activityFlowsExist:
        flowIndex = 0
        flowOrder = []
        flowProperties = []
    ...
    # fix missing identifier in screen activity items
